...
def arg_parse(args=None):
    """Parses the arguments in the configuration file
        ...
        configuration file for the dialogue (Default value = None)

    Returns a dictionary containing the settings in the configuration file and a
    ...
    if cfg_parser:
        ...
        return cfg_parser, cfg_parser['TELEGRAM'], cfg_parser['POLLING']
    else:
        raise ValueError(
