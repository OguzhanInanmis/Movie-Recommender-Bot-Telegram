"""NLG is a Natural Language Generator used to produce a human-like response for Dialogue Acts of the agent."""
import random
...
class NLG:
    ...
    def generate_output(self,
        ...
        Returns string containing natural response
        ...
        for agent_dact in agent_dacts:
            if agent_dact.intent == AgentIntents.WELCOME:
                ...
                if isBot:
                    if new_user:
                        intent_response += f'Hi {user_fname}. Welcome to Movie Recommender Bot! '
                    else:
    ...
    def _clarify_CIN(self, CIN, agent_dact):
        ...
        Returns a string for system utterance
    ...
    def _user_options_remove_preference(self, dual_params):
        ...
        Returns a list of button options
    ...
    def _user_options_inquire(self, dialogue_state):
        ...
        Returns list of user requestables as buttons
