"""This file contains the Database class for MABOT. The classes mentioned handle the
functinality of query processing for MABOT.
The database class is implemented for SQL DB."""
