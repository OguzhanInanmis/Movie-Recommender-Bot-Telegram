"""The Dialogue Manager controls the action-selection and state-tracking part of the MABOT
...
class DialogueManager:
    ...
    def database_lookup(self):
        """Performs a database query considering the current dialogue state (the current information needs)

        Returns The list of results matching user information needs
    ...
    def get_state(self):
        ...
        Returns the current state of Dialogue
    ...
    def get_context(self):
        ...
        Returns the current context of the conversation with a specific user
